...
// GPPG version 1.5.0
// Machine:  USER-PC
// DateTime: 07.11.2018 23:56:50
// UserName: user
// Input file <SimpleYacc.y - 07.11.2018 23:56:47>
...
public enum Tokens {
    ...
    TO=13,WRITE=14,OPBRACKET=15,CLBRACKET=16,IF=17,THEN=18,
    ELSE=19,VAR=20,COMMA=21,PLUS=22,MINUS=23,DIV=24,
...
{
  // Verbatim content from SimpleYacc.y - 07.11.2018 23:56:47
// Ýòè îáúÿâëåíèÿ äîáàâëÿþòñÿ â êëàññ GPPGParser, ïðåäñòàâëÿþùèé ñîáîé ïàðñåð, ãåíåðèðóåìûé ñèñòåìîé gppg
    public BlockNode root; // Êîðíåâîé óçåë ñèíòàêñè÷åñêîãî äåðåâà 
    public Parser(AbstractScanner<ValueType, LexLocation> scanner) : base(scanner) { }
  // End verbatim content from SimpleYacc.y - 07.11.2018 23:56:47
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "for", "write", "if", "stlist", "block", "idlist", "var", "progr", "$accept", 
      };
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-13,5,-6,44,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[5] = new State(new int[]{4,6,7,7});
    states[6] = new State(-25);
    states[7] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-6,8,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    ...
    states[14] = new State(new int[]{25,15,24,25,22,-17,23,-17,4,-17,7,-17,11,-17,19,-17,13,-17,16,-17,28,-17,3,-17,5,-17,8,-17,10,-17,12,-17,14,-17,17,-17,20,-17,9,-17,18,-17});
    ...
    states[24] = new State(new int[]{25,15,24,25,22,-18,23,-18,4,-18,7,-18,11,-18,19,-18,13,-18,16,-18,28,-18,3,-18,5,-18,8,-18,10,-18,12,-18,14,-18,17,-18,20,-18,9,-18,18,-18});
    states[25] = new State(new int[]{28,18,26,19,15,20},new int[]{-4,26,-2,17});
    states[26] = new State(-21);
    states[27] = new State(-19);
    states[28] = new State(new int[]{25,15,24,25,22,-16,23,-16,4,-16,7,-16,11,-16,19,-16,13,-16,16,-16,28,-16,3,-16,5,-16,8,-16,10,-16,12,-16,14,-16,17,-16,20,-16,9,-16,18,-16});
    states[29] = new State(-6);
    states[30] = new State(-7);
    states[31] = new State(new int[]{28,18,26,19,15,20},new int[]{-1,32,-3,28,-4,27,-2,17});
    states[32] = new State(new int[]{22,13,23,23,28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-6,33,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    ...
    states[37] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-6,38,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[38] = new State(-27);
    states[39] = new State(-9);
    states[40] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-13,41,-6,44,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    ...
    states[50] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-6,51,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    ...
    states[60] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-6,61,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[61] = new State(new int[]{19,62,4,-31,7,-31,11,-31});
    states[62] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,14,53,17,58,20,65},new int[]{-6,63,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[63] = new State(-32);
    states[64] = new State(-13);
    states[65] = new State(new int[]{28,18},new int[]{-15,66,-2,69});
    states[66] = new State(new int[]{21,67,4,-35,7,-35,11,-35,19,-35});
    ...
    rules[33] = new Rule(-15, new int[]{-2});
    rules[34] = new Rule(-15, new int[]{-15,21,-2});
...
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].vVal; }
        break;
      case 14: // ident -> ID
...
{ CurrentSemanticValue.eVal = new IntNumNode(ValueStack[ValueStack.Depth-1].iVal); }
        break;
      case 24: // F -> OPBRACKET, expr, CLBRACKET
...
{ CurrentSemanticValue.stVal = new ForNode(ValueStack[ValueStack.Depth-5].stVal as AssignNode, ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 30: // write -> WRITE, OPBRACKET, expr, CLBRACKET
...
{CurrentSemanticValue.stVal = new IfNode(ValueStack[ValueStack.Depth-5].eVal, ValueStack[ValueStack.Depth-3].stVal, ValueStack[ValueStack.Depth-1].stVal);  }
        break;
      case 33: // idlist -> ident
{ CurrentSemanticValue.vVal = new VarDefNode(ValueStack[ValueStack.Depth-1].eVal as IdNode); }
        break;
      case 34: // idlist -> idlist, COMMA, ident
{ 
		  ValueStack[ValueStack.Depth-3].vVal.Add(ValueStack[ValueStack.Depth-1].eVal as IdNode); 
		  CurrentSemanticValue.vVal = ValueStack[ValueStack.Depth-3].vVal;
		}
        break;
      case 35: // var -> VAR, idlist
{ CurrentSemanticValue.vVal = ValueStack[ValueStack.Depth-1].vVal; }
        break;
    }
