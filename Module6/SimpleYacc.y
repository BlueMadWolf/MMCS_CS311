...
%token BEGIN END CYCLE ASSIGN SEMICOLON WHILE DO REPEAT UNTIL FOR TO WRITE OPBRACKET CLBRACKET IF THEN ELSE VAR COMMA PLUS MINUS DIV MULT 
%token <iVal> INUM 
%token <dVal> RNUM 
%token <sVal> ID
